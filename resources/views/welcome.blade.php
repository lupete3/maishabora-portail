...
<body>
    ...
    <div class="site-wrap">
        ...
        <header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <a class="navbar-brand w-auto" href="index.html">
                    ...
                    <!-- logo dark--><img class="logo dark img-fluid" src="{{ asset('assets/images/logo.jpg') }}"
                        alt="Maisha Bora Asbl" width="50px">
                ...
                <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1"
                        ...
                        <div class="offcanvas-header-logo">
                            ...
                            <a class="logo-link" id="fbs__net-navbarsLabel" href="index.html">
                                ...
                                <!-- logo dark--><img class="logo dark img-fluid"
                                    src="{{ asset('assets/images/logo.jpg') }}" alt="Maisha Bora Asbl" width="50px">
                    ...
                    <div class="offcanvas-body align-items-lg-center">
                        ...
                        <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link scroll-link" href="#how-it-works">Comment ça
                                    marche</a></li>
        ...
        <main>
            ...
            <livewire:welcome.about-section />
            <livewire:welcome.features-section />
            <livewire:welcome.pricing-section />
            <livewire:welcome.how-it-works-section />
            <livewire:welcome.stats-section />
            <livewire:welcome.services-section />
            <livewire:welcome.testimonials-section />
            <livewire:welcome.faq-section />
            <livewire:welcome.contact-section />
                ...
                <div class="container">
                    <div class="row mb-5 pb-4">
                        <div class="col-md-7">
                            ...
                            <p>Restez à jour avec nos derniers modèles et offres - rejoignez notre newsletter dès
                                aujourd'hui !</p>
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="row justify-content-between mb-5 g-xl-5">
                        <div class="col-md-4 mb-5 mb-lg-0">
                            ...
                            <p class="mb-4">Utilisez nos outils pour développer vos concepts et donner vie à votre
                                vision. Une fois terminé, partagez vos créations sans effort.</p>
                        </div>
                        <div class="col-md-7">
                            <div class="row g-2">
                                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="#">Carrières <span class="badge ms-1">on recrute</span></a>
                                        </li>
                                ...
                                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0 quick-contact">
                                    ...
                                    <p class="d-flex mb-3"><i class="bi bi-geo-alt-fill me-3"></i><span>Avenue Patrice
                                            Lumumba, <br> Bukavu, R.D. Congo</span></p><a class="d-flex mb-3"
                                        href="mailto:contact@maishaboraasbl.com"><i
                                            class="bi bi-envelope-fill me-3"></i><span>contact@maishaboraasbl.com</span></a><a
                                        class="d-flex mb-3" href="tel://+243975391220"><i
                                            class="bi bi-telephone-fill me-3"></i><span>+243 975 391 220</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
