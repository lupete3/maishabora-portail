<div>
    <x-slot name="title">{{ __('Section Héros') }}</x-slot>

    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">{{ __('Gérer la Section Héros') }}</h5>
        </div>
        <div class="card-body">
            ...
            <form wire:submit.prevent="update">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="border p-3 rounded mb-3">
                            <h6>{{ __('Bouton Un') }}</h6>
                            <div class="mb-3">
                                <label for="button_one_text" class="form-label">{{ __('Texte') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="button_one_link" class="form-label">{{ __('Lien') }}</label>
                        ...
                        <div class="border p-3 rounded">
                            <h6>{{ __('Bouton Deux') }}</h6>
                            <div class="mb-3">
                                <label for="button_two_text" class="form-label">{{ __('Texte') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="button_two_link" class="form-label">{{ __('Lien') }}</label>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="new_image_card_path" class="form-label">{{ __('Image de la carte') }}</label>
                            ...
                            <div wire:loading wire:target="new_image_card_path" class="mt-2">Téléchargement...</div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="new_image_main_path" class="form-label">{{ __('Image Principale') }}</label>
                            ...
                            <div wire:loading wire:target="new_image_main_path" class="mt-2">Téléchargement...</div>
