    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ $service_id ? 'Edit Service' : 'Create Service' }}</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="icon" wire:model="icon" placeholder="e.g., bi bi-cash-coin">
