<div class="card">
    <div class="card-header">
        <h5 class="card-title">{{ $plan_id ? __('Edit Plan') : __('Create Plan') }}</h5>
    </div>
    <div class="card-body">
        <form wire:submit.prevent="store">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <label for="price_string" class="form-label">{{ __('Price String') }}</label>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="features" class="form-label">{{ __('Features (one per line)') }}</label>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="button_link" class="form-label">{{ __('Button Link') }}</label>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3 form-check mt-4">
                        ...
                        <label class="form-check-label" for="is_popular">{{ __('Is Popular') }}</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3 form-check mt-4">
                        <input type="checkbox" wire:model="is_active" class="form-check-input" id="is_active_plan">
                        <label class="form-check-label" for="is_active_plan">{{ __('Is Active') }}</label>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-primary">{{ $plan_id ? __('Update') : __('Save') }}</button>
