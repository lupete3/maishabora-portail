...
class WelcomePageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        AboutSection::create([
            ...
            'title' => 'Votre partenaire de confiance pour l\'inclusion financière à Bukavu',
            'description' => "Maisha Bora Asbl est une institution de microfinance dédiée à l'autonomisation économique des communautés de Bukavu. Nous offrons des services financiers accessibles et adaptés pour soutenir les petits entrepreneurs, les femmes et les jeunes.\n\nNotre plateforme de pointe garantit la sécurité, la simplicité et l'efficacité de vos transactions, vous permettant de prendre le contrôle de votre avenir financier avec confiance.",
            'values' => json_encode(['Intégrité', 'Transparence', 'Proximité', 'Innovation', 'Autonomisation']),
            'image_path' => 'assets/images/about_2-min.jpg',
            'mission_title' => 'Notre Mission',
            'mission_description' => "Notre mission est de fournir des services financiers durables qui favorisent l'entrepreneuriat et améliorent les conditions de vie des populations à faible revenu."
        ]);
